# Contributing to futures

This document is a guide to contributing to futures
...
## Building futures from source

You'll need to build futures locally in order to start editing code.

To install futures from source, clone the GitHub
...
To contribute to futures, send us pull requests.
For those new to contributing, check out GitHub's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the futures
...
If you'd like to add a new feature to futures, please do propose your
...
- Read the futures source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/futures/issues),
...
futures tests live in the directory `tests`,
